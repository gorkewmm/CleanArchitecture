...
namespace HR.LeaveManagement.Application.UnitTests.Features.LeaveTypes.Queries
{
    public class GetLeaveTypeListQueryHandlerTests
    {
        ...
        public GetLeaveTypeListQueryHandlerTests()  //GetLeaveTypesQueryHandler 'ı test ettiğimiz için onun bağımlılıklarını aynen vermek zorundayızki test tutarlı olsun.
        {
